...
const DisplayProgramData = (props) => {
    ...
    <img src={host + props.data.attributes.Image.data.attributes.formats.thumbnail.url} className="object-cover w-2/6 h-full smMax:w-full smMax:h-60"/>
    
    <Link to="/programma_post" className="flex flex-col justify-around w-7/12 mx-auto  lgMax:w-9/12 lgMax:ml-3 smMax:w-11/12 smMax:h-28 smMax-justify-center" onClick={() => {props.setProgramId(props.data.id)}}>
        <div>
            ...
            <div className="flex flex-row gap-3">
                ...
                <p className="font-barlow">{props.data.attributes.Dates[0].Date}</p>
                </div>
        </div>
