...
const page404 = () => {
    return <section className="bg-404Icon h-screen w-full bg-no-repeat bg-cover flex justify-center items-center">
        ...
        <div className="flex flex-col font-barlow w-2/4 justify-center items-center ">
            ...
            <h2 className="text-white font-bold text-heading3 mt-1">404 - Pagina niet gevonden</h2>
            <p className="text-white text-paragraphL w-10/12 text-center mt-1">Momenteel is de pagina niet beschikbaar.
